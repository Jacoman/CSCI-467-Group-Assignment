...
<label for="text-input">Sales Associate Name</label>
...
{
$pdo->exec("INSERT INTO SalesAssociate(Name,Email,Password)VALUES('".$_POST['Username']."', '".$_POST['Email']."', '".$_POST['Password']."')");
}
?>
